...
* Main background (images/background2.jpg) - this is the main background image provided via [Unsplash](https://unsplash.com/). This can be kept or changed easily by replacing `images/background2.jpg` with your new background (recommended size of at least 1920x1080).
